...
;; Set path for markdown-command to "/usr/local/bin/multimarkdown"
;; Set path for markdown-open-command to "/Applications/Marked\ 2.app/Contents/MacOS/Marked"

;; $Source: /Users/dan/.emacs.d/RCS/markdown-mode.el-v $
;; $Revision: 1.1 $
...
;;     first string in the list `markdownp-hr-strings' (the most
...
(defcustom markdown-command "/usr/local/bin/multimarkdown"
